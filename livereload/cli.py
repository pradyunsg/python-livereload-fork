...
parser.add_argument(
    "-p", "--port", help="Port to run `livereload` server on", type=int, default=35729
)
parser.add_argument(
    "directory", help="Directory to serve files from", type=str, default=".", nargs="?"
)
parser.add_argument(
    "-t",
    "--target",
...
parser.add_argument(
    "-d", "--debug", help="Enable Tornado pretty logging", action="store_true"
)
